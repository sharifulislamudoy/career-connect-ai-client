...
const Login = () => {
  ...
  const handleVerifyCode = async (e) => {
    ...
    try {
      await verifyCode(formData.email, cleanCode, "login");

      await logIn(formData.email, formData.password);

      try {
        await consumeVerificationCode(formData.email, cleanCode, "login");
      } catch (consumeError) {
          ...
          {step === "credentials" && (
            ...
            >
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-500 text-white py-4 rounded-2xl font-semibold shadow-lg shadow-blue-500/25 disabled:opacity-70 flex items-center justify-center"
              >
                {isLoading ? (
          ...
          {step === "verification" && (
            ...
            >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-500 text-white py-4 rounded-2xl font-semibold disabled:opacity-70 flex items-center justify-center"
              >
                {isLoading ? (
                  <FaSpinner className="animate-spin" />
                ) : (
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-3">
              <button
                ...
                disabled={isLoading}
                className="py-3 px-4 rounded-2xl text-sm font-semibold flex items-center justify-center space-x-2 bg-white/50 border border-gray-200 disabled:opacity-70"
              >
